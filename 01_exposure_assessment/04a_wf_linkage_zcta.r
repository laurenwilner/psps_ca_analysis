...
if(washout == TRUE){
psps_temp <- read_csv(paste0(intermediate_dir, "ca_zcta_event_level_psps_washout_2013-2022.csv"))
} else{
psps_temp <- read_csv(paste0(intermediate_dir, "ca_zcta_event_level_psps_no_washout_2013-2022.csv"))
}
