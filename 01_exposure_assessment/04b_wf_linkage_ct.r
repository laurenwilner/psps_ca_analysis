...
if(washout == TRUE){
    write.csv(psps_analysis, paste0(clean_dir, "ca_ct_event_level_psps_washout_wf_2013-2022.csv"), row.names = FALSE)
} else{
    write.csv(psps_analysis, paste0(clean_dir, "ca_ct_event_level_psps_no_washout_wf_2013-2022.csv"), row.names = FALSE)
}