...
psps_levels <- read_csv("D:/Caitlin/PSPS/Data/PSPS/ca_zcta_daily_psps_no_washout_classified_2013-2022.csv")
...
psps_daily <- merge(dates, daily_exposure, by = "date", all.x = TRUE)
